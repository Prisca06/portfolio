...
define('DB_USER', 'root');
define('DB_PASSWORD', 'swsSSMMaFhtwbLEXDojmMINoNaMGoGTU');
define('DB_HOST', 'roundhouse.proxy.rlwy.net:33816', 10);
define('DB_CHARSET', 'utf8mb4');
define('DB_COLLATE', '');

// ** Augmentation des ressources PHP ** //
define('WP_MEMORY_LIMIT', '512M'); // Augmente la mémoire PHP
define('WP_MAX_MEMORY_LIMIT', '512M');
@ini_set('max_execution_time', '300'); // Augmente le timeout PHP
@ini_set('memory_limit', '512M');
@ini_set('default_socket_timeout', '300');

// ** Désactivation des tâches automatiques WordPress ** //
...
// ** Debug Mode (Garde WP_DEBUG_LOG activé pour voir les erreurs en cas de problème) ** //
